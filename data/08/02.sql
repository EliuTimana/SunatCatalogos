CREATE TABLE table_02(
  ...
  ,Currency                 VARCHAR(3)
  ,CurrencyNumber           INTEGER
  ,CurrencyMeasurementUnits VARCHAR(4)
);
INSERT INTO table_02(CountryName,CurrencyName,Currency,CurrencyNumber,CurrencyMeasurementUnits) VALUES
...
,('ANTARCTICA','No universal currency',NULL,NULL,NULL)
...
,('BOLIVIA (PLURINATIONAL STATE OF)',NULL,'BOV',984,'2')
...
,('PALESTINE, STATE OF','No universal currency',NULL,NULL,NULL)
...
,('SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS','No universal currency',NULL,NULL,NULL)
...
,('SWITZERLAND',NULL,'CHE',947,'2')
,('SWITZERLAND',NULL,'CHW',948,'2')
...
,('UNITED STATES OF AMERICA (THE)',NULL,'USN',997,'2')
,('URUGUAY','Peso Uruguayo','UYU',858,'2')
,('URUGUAY',NULL,'UYI',940,'0')
